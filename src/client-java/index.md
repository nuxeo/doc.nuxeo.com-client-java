...
To use nuxeo-java-client, you can download it from our Nexus: [Nuxeo Client Library 3.4.0](https://maven.nuxeo.org/nexus/#nexus-search;gav%7Eorg.nuxeo.client%7Enuxeo-java-client%7E3.3.0%7Ejar%7E).
...
The 3.4 Nuxeo Java Client version is compatible with Java 11 and greater.
